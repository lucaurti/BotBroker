    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            try
            {
                ...
                {
                    //recupero path Broker.Common per copiare file Broker.db
                    DirectoryInfo BrokerRoot = new DirectoryInfo(AppContext.BaseDirectory).Parent.Parent.Parent.Parent;
                    File.Copy(
                        Path.Combine(BrokerRoot.FullName, "Broker.Common", "Broker.db"), 
