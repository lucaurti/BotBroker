...
namespace Broker.Common.Indicators
{
    ...
    public class LineIntersection
    {
        ...
        public static Point FindIntersection(Line lineA, Line lineB, decimal tolerance = (decimal)0.001)
        {
            ...
            {
                Log.Information("Crossover line: Both lines overlap vertically, ambiguous intersection points.");
            ...
            {
                Log.Information("Crossover line: Both lines overlap horizontally, ambiguous intersection points.");
                return default(Point);
            }
